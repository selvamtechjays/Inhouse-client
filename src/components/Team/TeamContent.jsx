...
import { addTracker, deleteTracker, getSingleEmpEdit, getallTracker, updateTracker } from "../../service/allapi";
          ...
          {records
            ...
            .map((team, index) => (
              <tr>
                ...
                <td className="ho"><Link><a className="bg-primary"><BsPencilSquare onClick={() => openForms(team._id)} className=' ms-1 icon'/></a>
              </Link> <a style={{ color: "#450c36" }}>
                    <BsFillTrash3Fill
